...
The canonical model for the genetics of adaptation has long been the sequential fixation of new mutations (\textbf{cite}). While it has been very useful heuristically for guiding studies in the field and lab (\textbf{cite}), this model is now rightfully understood as incomplete for many species in nature that have more complicated population structures (\textbf{cite}). In particular, empirical studies have increasingly pointed to the need to more deeply incorporate standing genetic variation (SGV) into adaptation dynamics for metapopulations inhabiting an array of habitats and experiencing diverse selective pressures while still exhibiting significant gene flow (\textbf{cite}). A growing number of empirical studies have identified instances of convergent evolution using SGV \citep{nelson2017ancient,Schrider2017,Barrett2008}. However, it is still not clear how variation in evolutionary processes - such as gene flow, recombination, selection and mutation -  can promote the maintenance and re-use of SGV, particularly during invasion and adaptation to new environments (\textbf{cite}). It is similarly unclear whether variation in these evolutionary processes can determine the genetic architecture of evolving traits via SGV. While emprical studies in the field and lab are essential, the use of simulation models of specific systems can greatly advanced our understanding of the adaptation genetic dynamics using SGV.
