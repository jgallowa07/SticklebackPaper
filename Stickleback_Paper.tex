...
-- I'm wondering if we can drop the following sentences that describe the findings from the Introduction. We state similar things in the abstract already, and the Introduction ends nicely with the previous sentence --
