...
%Which evolutionary processes promote the maintenance of re-use of such genetic polymorphisms? 
%How do these processes interact with diverse geographic contexts, as well as variation in populations genetic processes such as gene flow, recombination, selection to fully take advantage of SGV to locally adapt. 
...
%This small fish has long been used for studies of behavior, ecology and evolution in the wild, and has more recently become a model for understanding the genetic basis of adaptive evolution. 
%The ancestral marine form has given rise to millions of independently derived populations in recently de-glaciated regions of the Northern Hemisphere.
...
%which have each evolved a similar suite - or 'freshwater syndrome' - of phenotypes despite local differences. 
%Phnotypically, these freshwater patches which have 
...
%Impressively, this adaptive phenotypic evolution to freshwater environments can occur in mere millenia, in many cases since the end of the last ice age about 13,000 years ago. 
%Studies of the fossil record also clearly show that invasion of oceanic stickleback and local adaptation in freshwater has occurred repeatedly over millions of years, 
%often involving very similar phenotypic shifts as seen in contemporary populations.
...
%A finding from recent stickleback population genomic studies is that the same genomic regions, and in some cases the same haplotypes, are implicated in patterns of repeated evolution. (Cite?)
%These studies show that divergent stickleback populations are clearly still connected via bi-directional gene flow. 
%This reuse of standing genetic variation motivated empirical studies to ask whether this phenotypic and genomic evolution could occur in decades. 
...
This would seem to suggest that freshwater alleles are maintained in the marine individuals by repeated adaptation to freshwater environments and downstream gene flow from those locally adapted sub-populations.
...
(as described below $p(x) \approx 2x/45$),
...
\begin{table}[ht]
    ...
    \caption{
        ...
        \textbf{``Best''} shows the most negative trait value achievable
        ...
        This suggests that populations at $m=1$ have sufficient genetic variation
        to completely adapt (reach $-10$) using intact haplotypes,
        while at $m=0.1$ variation must be released from haplotypes by recombination.
    } \label{tab:linkage}
\end{table}
