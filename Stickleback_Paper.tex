...
\citep{jones_genomic_2012, roesti_genome_2012, feulner_genomics_2015, Schrider2017, Barrett2008, Nelson_2018, Nelson_2019, Bassham_2018}. \revpoint{3}{10}
...
Establishment of adaptive alleles in the old lakes during the first few thousand generations manifests as jumps in the mean trait value - which move the trait by an amount of order 1 every few hundred generations (Fig. \ref{fig:phenotype_time}). \revpoint{3}{4}
...
\begin{figure}
    \begin{center}
        ...
        The columns are ordered by the $M$ (number of migrants per lake, per generation) 
...
Outside of our specific colonization scheme two other possible scenarios, and their respective impact on our results, are relevant to discuss. \llabel{disc_colon}
In the case of a bottleneck and expanding population size post-colonization \emph{with} continued influx of migrant alleles,
we would expect time to adaptation for $M = \{0.1, 1.0, 10.0\}$ to be greater, and the origin of adaptive alleles to 
be weighted more towards ``migrant'' alleles. 
In the case of a bottleneck and expanding population size post-colonization \emph{without} continued influx of migrant alleles,
We would expect much less chance at selection on standing variants and most migration rates ($M = \{0.1, 1.0, 10.0\}$) 
to adapt at the same pace as selection on ``de-novo'' alleles ($M=0.01$).
