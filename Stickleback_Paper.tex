...
%\wac{How about 'A small number of stickleback ... }
...
The canonical model for the genetics of adaptation has long been the sequential fixation of new mutations \textbf{smith_haigh_1974 Endler_1977 Orr_2005}.
While it has proved to be a useful baseline for understanding the genetic variation we see in species today, this model is now rightfully understood as incomplete for many species in nature that have more complicated population structures \textbf{Lai2152, Schrider2017}. 
In particular, empirical studies have increasingly identified the need to more deeply incorporate standing genetic variation (SGV) into adaptation dynamics for metapopulations inhabiting an array of habitats \textbf{Hermisson_2005, Barrett_2008, Peter_2012, Burke_2014}. Populations experiencing diverse selective pressures while still exhibiting significant gene flow often result in more complex genomic signals that are still not fully understood \textbf{Charlesworth_1997, Charlesworth_2003, Leonormand_2002, Nosil_2009, Flaxman_2013, Samuk 2017}. 
A growing number of empirical studies have identified instances of convergent evolution using SGV \citep{Schrider2017,Barrett2008}, \textbf{Burke 2014, Nelson_2018, Nelson_2019, Bassham_2018}. 
However, it is still not clear how variation in evolutionary processes - such as gene flow, recombination, selection and mutation -  can promote the maintenance and re-use of SGV, particularly during colonization and adaptation to new environments \citep{nelson2017ancient}\textbf{Pritchard_2010,Yeaman_2011, Messer_2013, Shrider2017}. 
...
The ancestral marine form of threespine stickleback fish has given rise to millions of independently derived freshwater populations in recently de-glaciated regions around the Northern Hemisphere \textbf{Bell_1994, Bell_1994, Thompson_1997, Cresko_2007}. 
This model organism has provided some of the earliest data in a recent flood showing the heterogeneous nature of divergence across genomes \textbf{Hohenlohe_2010, Jones_2012, Terekhanova_2014, Marques_2016} and the much more extensive use of SGV than once thought \textbf{Schluter_2009, Roesti_2014,Nelson_2018, Bassham_2018, Nelson_2019}.  
While geographic isolation often prevents direct migration between freshwater populations, they frequently evolve similar phenotypes \textbf{Cresko_2004, Colosimo_2004, Shapiro_2005}. 
The most recent evolutionary genomic studies on stickleback document that while the overall dynamic of local adaptation to marine and freshwater habitats has been occurring for millions of years \textbf{Jones_2012, Nelson_2018}, independent local adaptation of marine individuals to freshwater environments has been observed to take place in just tens of generations \textbf{Terekhanova_2014, Lescak_2015, Bassham_2018}. 
For example, in 1964 the Great Alaskan Earthquake caused an uplift of many islands and coastal regions throughout the Gulf of Alaska \textbf{Pflaker_1969, Pflaker_1978}. 
Studies of stickleback populations on uplifted Middleton Island showed that newly created freshwater ponds were invaded by the surrounding marine population of stickleback which evolved the freshwater syndrome of phenotypes in less than 50 years (\textbf{Lescak_2015, Bassham_2018}). 
Amazingly, nearly a quarter of the genome diverged significantly in this same time but - with very little change in the rest of the genome - in a pattern that mirrored previous genomic studies of freshwater stickleback populations that have been geographically separated for thousands of years \textbf{Hohenlohe_2010, Bassham_2018}. 
...
The first clear example of the global reuse of SGV in stickleback was the gene \textit{eda} which has been shown to be an important regulator for the number of bony lateral plates \textbf{Colosimo_2004, Cresko_2004, Colosimo_2005}. 
While the low lateral plate version of this gene arose millions of years ago, it is found in much younger freshwater ponds around the Northern Hemisphere \textbf{O'Brown_2015}. 
