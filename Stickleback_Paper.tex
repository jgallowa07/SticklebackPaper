...
Surprisingly, for all cases with the exception of $M = 0.01$, we found that the majority of adaptive allele origins traced back the original generation of inhabitants in the lake (\autoref{fig:Origin}). \revpoint{1}{3}
In our simulations,
...
A freshwater and a marine allele in close proximity
