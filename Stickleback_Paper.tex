...
What role does genomic variation play in a metapopulation with connection to an array of selective pressures?
How could migration-selection balance actually benefit a super species as a whole in tandem with it experiencing divergent selection?
\jgg{these q's make sense to me, but could be utter non-sense to an experienced pop geneticist. lmk}
...
\begin{figure}
	\begin{center}
		...
		blue vertical lines with an alpha value of 0.3, so darker shades of blue imply more 
...
\jgg{There is still something wrong with this figure besides the labels ... }
