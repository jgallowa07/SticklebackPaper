...
\todo{Each set of simulations was run multiple times to ensure the data we observed was not stochastic.}
...
\todo{Should I put my geography picture here?}
...
\begin{figure}[h!tb]
	\begin{center}
  		\includegraphics[width=01.0\linewidth]{PhenotypeDist}
  		\caption{A boat.}
  		\label{fig:boat1}
	\end{center}
\end{figure}
