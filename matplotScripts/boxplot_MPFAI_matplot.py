...
for i in range(4):
	...
	File = open("../../Output1/MyRecipe"+recipes[i]+"/AvgFWAA_divTotal.txt","r")
	first = File.readline()
	count = 0
...
ax1.set_title('Mean Percentage of FAA per Individual Throughout Simulation')
ax1.set_ylabel('Percentage',fontsize='medium')
