...
firstdata,x1,x2 = phenoData("9_1_2")
seconddata,x11,x22 = phenoData("9_1_3")
thirddata,x111,x222 = phenoData("9_1_4")
...
axes[2].plot(x111,thirddata[0],lw=lw1)
axes[2].plot(x111,thirddata[1],lw=lw1)
axes[2].plot(x222,thirddata[27],lw=lw1)

for i in range(0,25):    
    axes[2].plot(x111,thirddata[i+2],c="y",lw=lw2)

for i in range(0,25):
    axes[2].plot(x222,thirddata[i+27],c='c',lw=lw2)
...
fig.savefig("./figs/Pheno_Time_supp.pdf")
