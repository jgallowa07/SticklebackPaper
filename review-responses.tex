...
more simulations (and \textit{careful} analysis), which we believe is outside the realm of this paper.
}
...
\reply{
This is a good point and was thought about by the authors. 
We believe this is worth noting \llname{disc_colon} in the manuscript but further exploration is outside the scope of this paper. 
}
...
\reply{
The authors agree that this is an interesting point of study. While this was explored in previous simulations, we thought it was outside the scope of this paper to make any statements about dominance.
}
...
\reply{
We agree this was confusing and have edited the ms to hopefully make it more clear \llname{mu_exp}. The motivation for 10 regions of effect was to model 'islands' of genetic divergence.
}
...
\reply{
Good point, I have found a few ambiguous spots and made sure to make this more clear
\revref
}
...
\reply{
Makes sense, the figure caption has been revised.
}
